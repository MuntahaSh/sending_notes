...
<body class="bg-[#FDFDFC] text-[#1b1b18] min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center px-4 sm:px-6">
        ...
        <div class="flex flex-col items-center w-full">
            ...
            <div class="w-full max-w-5xl
                       rounded-[28px] shadow-2xl ring-1 ring-white/60
                ...
                <p class="text-base sm:text-lg text-gray-600 max-w-xl mx-auto mb-10">
                    Welcome to our application! Get started by creating an account or logging in.
                </p>


                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center p-6">
                    <x-button class="px-10 py-3 text-base">
                        <a href="{{ route('register') }}" ">
                            Create Account
                        </a>

                    </x-button>
                    <x-secondary-button class=" px-10 py-3 text-base">
                            <a href=" {{ route('login') }}">
                                Log In
                            </a>
